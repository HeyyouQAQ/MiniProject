    ...
    <header className={`border-b px-4 md:px-6 lg:px-8 py-4 transition-colors duration-500 ${isDarkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'}`}>
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className={`transition-colors duration-500 ${isDarkMode ? 'text-white' : 'text-gray-800'}`}>Welcome, Manager</h1>
        ...
        <div className="flex items-center gap-2 md:gap-4">
          ...
          <div className={`hidden sm:flex items-center gap-3 pl-4 border-l transition-colors duration-500 ${isDarkMode ? 'border-gray-700' : ''}`}>
            <div className="text-right hidden md:block">
              <div className={`text-sm transition-colors duration-500 ${isDarkMode ? 'text-white' : ''}`}>Sarah Johnson</div>
              <div className={`text-xs transition-colors duration-500 ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>Manager</div>
            </div>
